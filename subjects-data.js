...
//
// To add a downloadable resource for a subject, add an object to that
// subject's `resources` array, e.g.:
//   resources: [
//     { title: "Topical past papers 2021-2025", type: "PDF", url: "resources/physics/topical-papers.pdf" },
//     { title: "Revision notes — Waves & Optics", type: "PDF", url: "https://drive.google.com/..." }
//   ]
// `url` can point to a file committed under a `resources/<subject-slug>/`
// folder in this repo, or to an external link (Google Drive, etc). The
// Resources page (resources.html) reads this file directly and lists
// whatever is here — there's no separate upload form, so only whoever can
// edit this file (and the repo) can add, change, or remove resources.
